import eliteMapping from './eliteMapping.json';
...
function cleanName(filename) {
  // Use mapping se existir, senao fallback
  const mapped = eliteMapping.find(m => m.originalName === filename);
  if (mapped && mapped.detectedName) return mapped.detectedName;
